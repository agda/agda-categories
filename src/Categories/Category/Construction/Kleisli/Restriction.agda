...
module Categories.Category.Construction.Kleisli.Restriction where
...
open import Categories.Category.Construction.Kleisli.CounitalCopy using (Kleisli-CounitalCopy)
