...
module _  (MC : Monoidal C) (MD : Monoidal D) where
  ...
  record StrongMonoidalFunctor : Set (levelOfTerm MC ⊔ levelOfTerm MD) where
    field
      F : Functor C D
